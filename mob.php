...
<div id="main">
    ...
    <img id="5" src="images/32.jpg" onclick="mydesign(this)">
    <img id="6" src="images/33.jpg" onclick="mydesign(this)">
    <img id="7" src="images/34.jpg" onclick="mydesign(this)">
    <img id="8" src="images/35.jpg" onclick="mydesign(this)">
    <img id="9" src="images/36.jpg" onclick="mydesign(this)">
    <img id="10" src="images/37.jpg" onclick="mydesign(this)">
    <img id="11" src="images/38.jpg" onclick="mydesign(this)">  
    </div>
...
<form action="preview1.php" method="post" enctype="multipart/form-data">
...
<ul>
    <li><img id="55" class="pre " src="images/11.jpg" onclick="mydesign(this)"></li>
    <li><img id="66" class="pre " src="images/12.jpg" onclick="mydesign(this)"></li>
    <li><img id="77" class="pre " src="images/13.jpg" onclick="mydesign(this)"></li>
    <li><img id="88" class="pre " src="images/39.jpg" onclick="mydesign(this)"></li>
    <li><img id="99" class="pre " src="images/40.jpg" onclick="mydesign(this)"></li>
    <li><img id="12" class="pre " src="images/41.jpg" onclick="mydesign(this)"></li>
    <li><img id="22" class="pre " src="images/42.jpg" onclick="mydesign(this)"></li>
    <li><img id="33" class="pre " src="images/43.jpg" onclick="mydesign(this)"></li>
    <li><img id="44" class="pre " src="images/44.jpg" onclick="mydesign(this)"></li>
    <li><img id="45" class="pre" src="images/45.jpg" onclick="mydesign(this)"></li>
    </ul>
